  ...
  return (
    <>
      {projects.map((project) => (
        <Card key={0} className="flex flex-col justify-between">
          <CardHeader>
                ...
                <>
                  {project.icons.map((icon) => {
                    ...
                    if (
                      ...
                      return <Icon key={0} className="h-4 w-4" color="#000000" />;
                    } else {
                      return <Icon key={0} className="h-4 w-4" color={icon.color} />;
                    }
                  })}
                </>
              ) : (
