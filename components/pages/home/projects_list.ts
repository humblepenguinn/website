...
export const projects = [
    {
      ...
      website: "",
      description: "A open source CLI tool that helps make managing environment variables a breeze",
      summaryPoints: [
    ...
    },
    {
      ...
      website: "",
      description: "A Chat Application that allows users to send and receive messages",
      summaryPoints: [
    ...
    },
    {
      ...
      website: "",
      description: "A blockchain wallet that allows users to send and receive cryptocurrency",
      summaryPoints: [
    ...
    },
    {
      ...
      website: "",
      description: "Blaze is a modern and minimal Node.js package manager designed to offer similar functionality to npm and Yarn, but with a key advantage: it is written in Rust, making it exceptionally fast.",
      summaryPoints: [
    ...
    },
    {
      ...
      website: "",
      description: "A Youtube Clone that allows users to watch videos, see channel information, search for videos, and more",
      summaryPoints: [
