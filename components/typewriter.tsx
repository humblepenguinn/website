...
class Typewriter extends React.Component<TypewriterProps, TypewriterState> {
  static defaultProps: { text: string; minTypeSpeed: number; maxTypeSpeed: number; initDelay: number; };
  ...
  clicketyClack(text: string, minTypeSpeed: number, maxTypeSpeed: number, initDelay: number) {
    let str = '';
    let typeSpeed = 0;
